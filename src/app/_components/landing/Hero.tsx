...
export default function Hero() {
  return (
    <section className="relative bg-gradient-to-b from-dark-900 to-dark-800 py-20 md:py-28">
      ...
      <div className="container relative mx-auto px-4">
        <div className="flex flex-col items-center md:flex-row md:space-x-12">
          ...
          <div className="mb-16 md:mb-0 md:w-1/2">
            <div className="rounded-3xl bg-dark-800/50 backdrop-blur-sm p-8 shadow-card border border-dark-600">
          ...
          <div className="md:w-1/2">
            <div className="relative h-72 w-full md:h-[400px]">
              <div className="flex h-full w-full items-center justify-center rounded-3xl bg-dark-800/70 backdrop-blur-sm p-8 shadow-card border border-dark-600">
                {/* App window mockup with the PillUI component */}
                <div className="w-full max-w-md rounded-2xl bg-dark-700 overflow-hidden shadow-lg">
                  {/* Window header */}
