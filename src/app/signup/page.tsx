      ...
      async (event: AuthChangeEvent) => {
        if (event === 'SIGNED_IN') {
          ...
          if (sessionError) {
            ...
            setAuthError('Failed to retrieve session details. Please check your account or try again.');
          ...
          if (session?.access_token && session?.refresh_token) {
            ...
            setAuthError('Account created but failed to get tokens for app redirect.');
          ...
          // Usually no UI action needed here for signup page
           ...
           setAuthError("Sign up failed. Please check your details or try again.");
           setAuthLoading(false);
        } else {
