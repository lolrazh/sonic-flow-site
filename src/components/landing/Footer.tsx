      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-8">
          <div className="flex items-center mb-6 md:mb-0">
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-dark-800 shadow-md mr-3">
            ...
            <div>
              <h3 className="text-lg font-medium text-dark-100">Sonic Flow</h3>
        ...
        {/* Orange divider */}
        <div className="h-px w-full bg-gradient-to-r from-accent-700/20 via-accent-600/30 to-accent-700/20 mb-8"></div>
